...
sumo_binary = sumolib.checkBinary('sumo-gui')  # Chosen 'sumo-gui' to be able to see the GUI
...
def run_sumo():
    ...
    step = 0
    try:
        while step < 190:  # Running this for 200 steps, but can make it run indefinitely
